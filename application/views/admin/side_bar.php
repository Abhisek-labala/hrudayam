            ...
            <ul>
               ...
               <li> 
                  <a href="<?php echo base_url();?>admin-dashboard"><i class="fa fa-home"></i> <span>Dashboard</span></a>
					...
					<li class="submenu">
					<a href="#"><i class="fa fa-document"></i> <span> Create </span> <span class="menu-arrow"></span></a>
						<ul style="display: none;">
							
                     <!-- <li> 
                        <a href="<?php echo base_url();?>Create-Educator"> <span> Educator</span></a>
                     </li>

                     <li> 
							   <a href="<?php echo base_url();?>Create-Doctor"> <span>  Doctor</span></a>
							</li>                    

                      <li> 
							   <a href="<?php echo base_url();?>Create-District-Manager"><span> District Manager</span></a>
							</li>

							<li> 
							<a href="<?php echo base_url();?>Create-Zone-Manager"> <span> Zone Manager</span></a>
							</li>   -->
						</ul>
					</li>
					...
					<a href="#"><i class="fa fa-document"></i> <span> Assign </span> <span class="menu-arrow"></span></a>
						<ul style="display: none;">
							<!-- <li> 
							<a href="<?php echo base_url();?>Assign-District-Manager"><span> District Manager</span></a>
							</li>
							<li> 
							<a href="<?php echo base_url();?>Assign-Educator"><span>Assign Educator</span></a>
							</li>
							<li> 
							<a href="<?php echo base_url();?>Map-Educator-To-Doctor"><span>Assign Doctor</span></a>
							</li> -->
						</ul>
					</li>
				...
				<li> 
                  <a href="<?php echo base_url();?>admin-change-password"><i class="fa fa-key"></i> <span>Change Password</span></a>
               </li>

			   <li> 
                  <a href="<?php echo base_url();?>admin-logout"><i class="fa fa-sign-out" aria-hidden="true"></i> 
				  <span>Logout</span></a>
               </li>
