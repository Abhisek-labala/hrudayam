				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body"> 
								<form action="Create-Doctor-Post" name="createDoctor" id="createDoctor" method="post" enctype="multipart/form-data" >
									<div class="mb-3 row">
									...
									<div class="mb-3 row">
										<label class="col-form-label col-md-2">Doctor Registration No: </label>
										<div class="col-md-10">
											<input type="text" maxlength="50" class="form-control" name="registration_no" id="registration_no">
										</div>
									</div>
                                    ...
                                    <div class="mb-3 row">
										<label class="col-form-label col-md-2">About Doctor </label>
										<div class="col-md-10">
