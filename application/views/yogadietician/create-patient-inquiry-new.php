                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-md-8">
                                    <input type="file" accept="image/*"  name="fileToUpload[]"
                                       id="fileToUpload" style="width:100%;" required="" multiple>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           ...
                           <div class="col-md-6 col-lg-6" id="followupdiv">
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-md-6">
                                    <input type="file" accept="image/*"  name="purchasebill"
                                       id="purchasebill" style="width:100%;" multiple="multiple">
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="col-md-6 col-lg-6" id="consentFormDiv">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-4" for="mobile_number">Upload Consent Form<span
                                          class='mandatory'>*</span></label>
                                    <div class="col-md-8">
                                       <input type="file" accept="image/*"  name="consentForm"
                                          id="consentForm" style="width:100%;" required="" multiple="multiple">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-6 col-lg-6">
