	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="MIS-Create-Doctor-Post" name="createDoctor" id="createDoctor" method="post"
...
<script>
	...
	$('#state').on('change', function () {
		...
		if (stateCode !== '') {
			$.ajax({
				url: 'MIS-Get-cities', // Make sure this URL matches your route/controller
				type: 'POST',
				dataType: 'json',
	...
	$('#city').on('change', function () {
		...
		$.ajax({
			url: 'MIS-Get-zones', // Your API route
			type: 'GET',
			dataType: 'json',
			success: function (response) {
				if (response.status === 'success') {
