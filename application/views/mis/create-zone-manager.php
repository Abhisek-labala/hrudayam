					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Zonal Manager Registration</h4>
							</div>
							<div class="card-body">
								<form action="Create-Zone-Post" name="createDoctor" id="districtManager" method="post" enctype="multipart/form-data" >
									<div class="mb-3 row">
