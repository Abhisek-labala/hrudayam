      ...
      <div class="sidebar-inner slimscroll" style="overflow: hidden; width: 100%; height: 593px;overflow-y: scroll;">
         <div id="sidebar-menu" class="sidebar-menu">
            <ul>
               ...
               <li> 
                  <a href="<?php echo base_url();?>pm-dashboard"><i class="fa fa-home"></i> <span>Dashboard</span></a>
               </li>
					...
					<a href="#"><i class="fa fa-document"></i> <span> ADD/DELETE </span> <span class="menu-arrow"></span></a>
                     ...
                     <li> 
                        <a href="<?php echo base_url();?>Pm-Create-Educator"> <span> EDUCATOR</span></a>
                     </li>

                     <li> 
							   <a href="<?php echo base_url();?>Pm-Create-Doctor"> <span>  HCP</span></a>
							</li>                    
                     ...
                     <li> 
							...
							<li> 
							<a href="<?php echo base_url();?>Create-Zone-Manager"> <span> COMPETITOR BRAND</span></a>
							</li>   -->
						</ul>
					</li>
					...
					<a href="#"><i class="fa fa-document"></i> <span> Assign </span> <span class="menu-arrow"></span></a>
						<ul style="display: none;">
							<li> 
							<a href="<?php echo base_url();?>PM-Assign-EDUCATOR"><span>EDUCATOR</span></a>
							</li>
							<li> 
