            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h5 class="card-title">Top Educators Prescribed Cipla Brand</h5>
                            </div>
                            <div class="card-body">
                                <canvas id="topEducatorsChart" height="200"></canvas>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header">
                                <h5 class="card-title">Top Educators Not Prescribed Cipla Brand</h5>
                            </div>
                            <div class="card-body">
                                <canvas id="nottopEducatorsChart" height="200"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="docnot" height="150"></canvas>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const API_BASE_URL = '<?= base_url() ?>Charts/pm';
     ...
     data.sort((a) => a.educator_name);
            const cardBody = document.querySelector('#nottopEducatorsChart').closest('.card-body');
            cardBody.innerHTML = `
            <ol class="list-group list-group-numbered">
                ${data.slice(0, 5).map(e => `
                    <li class="list-group-item border-0 ps-0">
