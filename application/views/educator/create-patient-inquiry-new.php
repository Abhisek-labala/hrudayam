...
<div class="main-wrapper">
   ...
   //       $('#medicine_header').on('change', function() {
   //      var selectedHeader = $(this).val();
        
   //      // Clear and disable medicine dropdown initially
   //      $('#medicine').html('<option value="">-- Select Medicine --</option>').prop('disabled', true);
        
   //      if (selectedHeader) {
   //          // Make AJAX call to get medicines for selected header
   //          $.ajax({
   //              url: '/Educator/getMedicinesByHeader', // You'll need to create this endpoint
   //              type: 'POST',
   //              data: { header: selectedHeader },
   //              dataType: 'json',
   //              success: function(response) {
   //                  if (response.status === 'success' && response.medicines.length > 0) {
   //                      $('#medicine').html('<option value="">-- Select Medicine --</option>');
                        
   //                      // Add each medicine to the dropdown
   ...
   //                  } else {
   //                      alert('No medicines found for this header');
   //                      $('#medicine').html('<option value="">-- No medicines available --</option>');
   //                  }
   //              },
   //              error: function() {
   ...
   //  });
         ...
         $('input[name="patientEnrolled"], input[name="ciplaBrandPrescribed"]').change(function() {
         updateFormFields();
      });
      
      function checkactivecamp()
      {
         $.ajax({
                  url: '/Educator/activeCamp',  // backend PHP file
                  type: 'GET',
                  dataType: 'json',
                  success: function(response) {
                     if (response.status === 'success') {
                        ...
                        alert('First Start The Camp Before Entry');
                        // window.location.reload();
                     }
                  },
                  error: function() {
                     alert('Something went wrong while Entry');
                  }
               });
      }

      // Initial call to set up form based on default values
      updateFormFields();
    ...
    if (patientEnrolled === 'Yes' && ciplaBrandPrescribed === 'Yes') {
        $("#consentFormDiv").show();
        ...
        $("#consentForm").prop('required', true);
    ...
    // Always show Cardio and Medication sections if Cipla Brand is Yes
    if (ciplaBrandPrescribed === 'Yes') {
        $("#ciplaBrandPrescribedDiv").show();
    } else {
        $("#ciplaBrandPrescribedDiv").hide();
    }
               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="hcp_name">HCP Name <span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                     ...
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="msl_code">MSL Code<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text" maxlength="50" class="form-control" name="msl_code" id="msl_code" value="" required>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="city">State <span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                     ...
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="city">City<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="speciality">Speciality<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
            ...
            <div class="card mb-4">
               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="patient_name">Patient Name<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text" maxlength="50" class="form-control" name="patient_name" id="patient_name" value="" required>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="age">Age<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="mobile_number">Mobile Number<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text" maxlength="10" class="form-control" name="mobile_number" id="mobile_number" value="" required>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="gender">Gender<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-6" id="prescriptionDiv">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="mobile_number">Upload Prescription<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                     ...
                     <div class="col-md-4 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="gender">Cipla Brand Prescribed<span class='mandatory'>*</span></label>
                           <div class="col-md-6">
                              <span class="radio">
                              <label><input type="radio" name="ciplaBrandPrescribed" id="ciplaBrandPrescribed" checked value="Yes"> Yes</label>
                              </span>
                              <span class="radio">
                              <label><input type="radio" name="ciplaBrandPrescribed" id="ciplaBrandPrescribed" value="No"> No</label>
                              </span> 
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="speciality">Patient Enrolled<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <span class="radio">
                     ...
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="patient_kit_enrolled">Kit Enrolled<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <span class="radio">
                  ...
                  <div class="col-md-4 col-lg-4" id="medicinediv">
                  <!-- <div class="row">
                     <div class="mb-2">
                           <label class="col-form-label col-md-6" for="gender">Medicine Header<span class='mandatory'>*</span></label>
                                    <select class="form-select form-control" name="medicine_header" id="medicine_header" >
                                 <option value="">-- Select Medicine Header--</option>
                                 
                              </select>
                        </div>
                  </div> -->
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="gender">Medicine<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <select class="form-select form-control" name="medicine[]" id="medicine" multiple size="3"  style="height:70px;">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-6" id="consentFormDiv">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4" for="mobile_number">Upload Consent Form<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="file" accept="image/*" capture="camera" name="consentForm" id="consentForm" style="width:100%;" required="" multiple="multiple">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                           <div class="mb-3 row">
                              <label class="col-form-label col-md-4" for="gender">Compititor<span class='mandatory'>*</span></label>
                              <div class="col-md-8">
                                 <select class="form-select form-control" name="Compititor[]" id="Compititor" multiple size="3" required style="height: 70px;">
                                    <option value="">-- Select Compititor --</option>
                                    <option value="N/A">N/A</option>
                                    <?php 
                                       $Compititors = Compititors();
                                       foreach ($Compititors as $med): ?>
                                    <option value="<?= $med['name'] ?>"><?= htmlspecialchars($med['name']) ?></option>
                                    <?php endforeach; ?>
                                 </select>
                              </div>
                           </div>
            ...
            <div class="card mb-4">
               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-6" for="date_of_discharge">Date of Discharge</label>
                           <div class="col-md-6">
                              <input type="text" maxlength="10" class="form-control datepicker" name="date_of_discharge" id="date_of_discharge" value="<?php echo date('Y-m-d')?>">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-5" for="blood_pressure">Blood Pressure<span class='mandatory'>*</span></label>
                           <div class="col-md-7">
                              <input type="text" placeholder="Systolic /Diastolic (mm Hg)" maxlength="10" class="form-control" name="blood_pressure" id="blood_pressure" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-9">
                              <input type="text" placeholder="(mg/dL)" maxlength="10" class="form-control" name="urea" id="urea" value="" >
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text" placeholder="(%)"  maxlength="10" class="form-control" name="lv_ef" id="lv_ef" >
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-3" for="heart_rate">Heart Rate<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text"  placeholder="bpm" maxlength="10" class="form-control" name="heart_rate" id="heart_rate">
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text" placeholder="(pg/mL)"  maxlength="50" class="form-control" name="nt_pro_bnp" id="nt_pro_bnp" >
                           </div>
                        </div>
                     </div>
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text" placeholder="(mL/min/1.73m2)" maxlength="10" class="form-control" name="egfr" id="egfr" >
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-3">Potassium<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text" placeholder="(mmol/L)" maxlength="50" class="form-control" name="potassium" id="potassium">
                           </div>
                        </div>
                     </div>
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mmol/L)" maxlength="10" class="form-control" name="sodium" id="sodium" >
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)" maxlength="50" class="form-control" name="uric_acid" id="uric_acid">
                           </div>
                        </div>
                     </div>
                     <div class='col-md-6 col-lg-6'>
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)"  maxlength="10" class="form-control" name="creatinine" id="creatinine" >
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/L)" maxlength="10" class="form-control" name="crp" id="crp">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/g)" maxlength="10" class="form-control" name="uacr" id="uacr">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mcg/dL)" maxlength="10" class="form-control" name="iron" id="iron">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(g/dL)" maxlength="10" class="form-control" name="hb" id="hb">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)" maxlength="10" class="form-control" name="ldl" id="ldl">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)" maxlength="10" class="form-control" name="hdl" id="hdl">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-3">Triglycerides<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)" maxlength="10" class="form-control" name="triglycerid" id="triglycerid" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-4">Total Cholesterol<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <input type="text"  placeholder="(mg/dL)" maxlength="10" class="form-control" name="total_cholesterol" id="total_cholesterol" value="">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(%)" maxlength="10" class="form-control" name="hba1c" id="hba1c" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(U/L)" maxlength="10" class="form-control" name="sgot" id="sgot" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(U/L)" maxlength="10" class="form-control" name="sgpt" id="sgpt" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(ng/mL)" maxlength="10" class="form-control" name="vit_d" id="vit_d" value="">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(ng/mL)" maxlength="10" class="form-control" name="t3" id="t3" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text"  placeholder="(ng/mL)" maxlength="10" class="form-control" name="t4" id="t4" value="">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <select class="form-select form-control" name="sglt2_inhibitors" id="sglt2_inhibitors">
                                 <option value="">-- Select--</option>
                     ...
                     <div class="col-md-6 col-lg-6">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-3" for="hypertension_angina_ckd">Hypertension, Angina, CKD<span class='mandatory'>*</span></label>
                           <div class="col-md-8">
                              <select class="form-select form-control" name="hypertension_angina_ckd" id="hypertension_angina_ckd">
                                 <option value="">-- Select--</option>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           <label class="col-form-label col-md-3" for="anti_diabetic_therapy">Anti Diabetic Therapy (Optional)</label>
                           <div class="col-md-8">
                              <input type="text" class="form-control" name="anti_diabetic_therapy" id="anti_diabetic_therapy">
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <select class="form-select form-control" name="arni" id="arni" onchange="toggleArniRemark();">
                                 <option value="">-- Select--</option>
                                 <option value="sacubitrilOrvalsartan">Sacubitril/Valsartan</option>
                                 <option value="remark">Remark</option>
                              </select>
                              <div id='arni_remark_div' style='display:none;'>
                                 <input type="text" maxlength="50" placeholder="ARNI Remark" class="form-control mt-2" name="arni_remark" id="arni_remark">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <select class="form-select form-control" name="b_blockers" id="b_blockers" onchange='toggleBlockersRemark()'>
                                 <option value="">-- Select--</option>
                              ...
                              <div id='blockers_remark_div' style='display:none;'>
                                 <input type="text" maxlength="50" placeholder="B Blockers Remark" class="form-control mt-2" name="b_blockers_remark" id="b_blockers_remark">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-4 col-lg-4">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <select class="form-select form-control" name="mra" id="mra" onchange='toggleMraRemark()'>
                                 <option value="">-- Select--</option>
                              ...
                              <div id='mra_remark_div' style='display:none;'>
                                 <input type="text" maxlength="50" placeholder="MRA Remark" class="form-control mt-2" name="mra_remark" id="mra_remark">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="vaccination" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="influenza" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="pneumococcal" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="cardiac_rehab" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="nsaids_use" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              ...
                              <span class="radio">
                              <label><input type="radio" name="patient_kit_given" value="na" checked="checked"> N/A</label>
                              </span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-8">
                              <input type="text" maxlength="100" class="form-control" name="remark" id="remark" placeholder="Enter any remark">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div id="optionaldiv">
                        ...
                        <div class="col-md-3 col-lg-3">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-8">
                                 <input type="text" placeholder="Weight In Kg" class="form-control" name="weight" id="weight"  maxlength="10" onkeydown="calculateBMI()">
                              </div>
                           </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-8">
                                 <input type="text" placeholder="Height In Cm" class="form-control" name="height"  id="height" maxlength="10" onkeydown="calculateBMI()">
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-7">                
                                 <input type="text" placeholder="Waist circumference In Cm"  maxlength="10" class="form-control" onkeydown="calculateWH()" name="waist_circumference_remark" id="waist_circumference_remark">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-6 col-lg-6">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-8">
                                 <input type="text" maxlength="10" class="form-control" name="bmi" id="bmi" placeholder="BMI In kg/m2">
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                     ...
                     <div class="row">
                        <div class="col-md-5 col-lg-5" style="background-color: #f3f3f3;">
                           ...
                           <div class="row">
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Type 2 DM<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Hypertension<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Dyslipidemia<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">PCO<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Knee pain (Osteoarthritis)<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Asthma<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                        ...
                        <div class="col-md-5 col-lg-5" style="background-color: #f3f3f3;">
                           ...
                           <div class="row">
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Bathing<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Dressing<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Walking<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                              ...
                              <div class="col-md-12 col-lg-12">
                                 <div class="mb-3 row">
                                    <label class="col-form-label col-md-6">Toileting<span class='mandatory'>*</span></label>
                                    <div class="col-md-5">
                                       <span class="radio">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-7">
                                 <span class="radio">
                                 <label><input type="radio" name="food_habits" value="Vegetarian"> Vegetarian</label>
                                 </span>
                                 <span class="radio">
                                 <label><input type="radio" name="food_habits" value="Non-vegetarian"> Non-vegetarian</label>
                                 </span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                           <div class="mb-3 row">
                              ...
                              <div class="col-md-5">
                                 <span class="radio">
                                 <label><input type="radio" name="sedentary_hours" value="≤8 hours"> ≤8 hours</label>
                                 </span>
                                 <span class="radio">
                                 <label><input type="radio" name="sedentary_hours" value=">8 hours"> >8 hours</label>
                                 </span>
                     ...
                     <div class="card-body mb-4">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-12" style="text-align: center;">
                                <button type="submit" name="submit" id="submit" class="btn btn-primary thembutton" onclick="return validateForm();">Submit</button>
                            </div>
                        </div>
