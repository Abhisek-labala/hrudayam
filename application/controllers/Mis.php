...
class Mis extends CI_Controller {
	...
	public function adminDashBoardTable()
	{
		...
		$this->load->view('mis/dashboardTable',$viewData);
	...
	{				
		$this->load->view('mis/create-district-manager');	
	}
...
if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
	...
	{				
		$this->load->view('mis/create-zone-manager');	
	}
...
if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
	...
	{				
		$this->load->view('mis/assign-educator-view');	
	}public function assignHcpView()
	{
		$this->load->view('mis/misassign-hcp-view');
	}


	public function MisassignEducatorPost()
{
	...
	public function MisassignHcpPost()
{
	if (ob_get_contents()) ob_clean();
    header('Content-Type: application/json');
    header('Content-Encoding: identity');
	...
	{				
		$this->load->view('mis/map-edcator-to-doctor-view');	
	}
	...
	{				
		$this->load->view('mis/assign-district-manager-view');	
	}
   ...
   //die();
	...
	{				
		$this->load->view('mis/doctors-list');	
	}
	
	public function educatorsList()
	{				
		$this->load->view('mis/educators-list');	
	}
	
	public function zoneManagerList()
	{				
		$this->load->view('mis/zone-manager-list');	
	}
	
	public function districtManagerList()
	{				
		$this->load->view('mis/district-manager-list');	
	}
	
	public function changePassword()
	{				
		$this->load->view('mis/change-password');	
	}
	...
	{				
		if ($_SERVER['REQUEST_METHOD'] === 'POST') {
			...
			redirect(base_url().'/mis-change-password');
			}
			...
			$adminId = $this->session->userdata('mis_id');
	...
	public function logout(){
		$this->session->unset_userdata('mis_id');
		redirect(base_url().'/mis-login');
	}
	...
	public function users(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/users_list',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function properties(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/property_list',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function auctions(){
		...
		$data['page'] = $page;
		$this->load->view('mis/header');
		$this->load->view('mis/auction_list',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function contact_us(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/contacts_list',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function activeDeactiveUser(){
		...
		$main_array = array();$json_users_data = array();$json_agent_data = array();
		if($row && $row_agent){
	...
	public function viewUser(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/viewUser',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function viewContact(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/viewContact',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function viewProperty(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/viewProperty',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function reviews(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/review_list',$data);
		$this->load->view('mis/footer');	
	}
	...
	public function activeDeactiveReview(){
		...
		$main_array = array();$json_review_data = array();
	...
	public function viewReview(){
		...
		$this->load->view('mis/header');
		$this->load->view('mis/viewReview',$data);
		$this->load->view('mis/footer');	
	}
...
public function getEducators()
	...
	{
		$this->load->view('mis/create-doctor');
	}
