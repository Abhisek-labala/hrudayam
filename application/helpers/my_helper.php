...
function getEducatorPatient($educatorId){
	$CI =& get_instance();	
	$query = "SELECT * FROM `patient_inquiry_new` WHERE `educator_id`='".$educatorId."' ORDER BY `date` desc";
	//echo $query;
...
function getDigitalEducatorPatient($digital_educator_id){
	$CI =& get_instance();	
	$query = "SELECT * FROM `patient_inquiry_new` WHERE `digital_educator_id`='".$digital_educator_id."' ORDER BY `date` desc";
	//echo $query;
	$EducatorPatient = $CI->master_model->customQueryArray($query);	
	return array('EducatorPatient'=>$EducatorPatient); 
}  
