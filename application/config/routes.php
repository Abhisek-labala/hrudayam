...
$route['Pm-Update-Educator-Post']   	    = "Pm/updateEducatorPost";
$route['Pm-Update-DigiEducator-Post']   	    = "Pm/updatedigitalEducatorPost";
$route['Pm-Update-Rm-Post']   	    = "Pm/updatermPost";
$route['Pm-Update-Doctor']   	    = "Pm/updatedoctorPost";
...
$route['Pm-Get-Educator/(:num)'] = "Pm/getEducator/$1";
$route['Pm-Get-DigiEducator/(:num)'] = "Pm/getDigiEducator/$1";
$route['Pm-Get-Rm/(:num)'] = "Pm/getRmdata/$1";
$route['Pm-Get-Doctor/(:num)'] = "Pm/getdoctordata/$1";
...
$route['Mis-logout']             = "Mis/logout";
$route['Mis-Get-Educator/(:num)'] = "Mis/getEducator/$1";
$route['Mis-Get-DigiEducator/(:num)'] = "Mis/getDigiEducator/$1";
$route['Mis-Get-Rm/(:num)'] = "Mis/getRmdata/$1";
$route['Mis-Get-Doctor/(:num)'] = "Mis/getdoctordata/$1";
$route['Mis-Update-Educator-Post']   	    = "Mis/updateEducatorPost";
$route['Mis-Update-DigiEducator-Post']   	    = "Mis/updatedigitalEducatorPost";
$route['Mis-Update-Rm-Post']   	    = "Mis/updatermPost";
$route['Mis-Update-Doctor']   	    = "Mis/updatedoctorPost";
